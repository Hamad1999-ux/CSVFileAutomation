...
try:
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)),'input.csv'),"r", newline='' , encoding='UTF8') as I:
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)),'output.csv'),"w", newline='' , encoding='UTF8') as O:
